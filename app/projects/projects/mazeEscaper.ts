...
const projectItem: ProjectItem = {
  title: "Maze Escaper",
  description:
    "Have you ever played a computer maze game where you can't see the whole map? This is it, you can only see the ways from where you are standing. Get the key and escape the maze, but becareful, because there will be ghosts.",
  labels: ["game"],
  highlights: [
