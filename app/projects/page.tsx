  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="flex justify-center">
        <div className="bg-secondary-400 w-full md:rounded-full md:mx-8 mb-8 text-secondary-900 text-3xl font-thin text-center px-8 py-4 slide-in-from-right-10 duration-1000 animate-in">
      ...
      <div>
        <div className="flex items-start gap-8 2xl:gap-16">
          ...
          <div className="mx-auto xl:mx-0 max-w-full md:max-w-screen-md lg:max-w-screen-sm xl:max-w-screen-lg">
